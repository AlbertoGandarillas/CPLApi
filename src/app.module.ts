...
@Module({
  imports: [CPLTypesModule, ImplementedCollegesModule, CollegesModule, UiSettingsModule, PotentialSavingsModule, IndustryCertificationsModule, CPLLearningModesModule, EmailModule, CPLRequestModule, CPLCoursesModule, CPLInquiryModule, SendCPLRequestModule, MostCommonTopcodesModule, MostCommonCrsModule, MostCommonCidsModule, CPLArticulationsModule],
  controllers: [],
