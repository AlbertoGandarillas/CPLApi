    ...
    async findAll() {
        try {
            ...
            if (colleges.length === 0) {
                throw new common_1.NotFoundException('No colleges found');
            }
            return colleges;
        }
        catch (error) {
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Returns all Colleges' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'No colleges found' }),
