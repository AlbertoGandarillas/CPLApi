...
let UISettingsService = class UISettingsService {
    ...
    async findBySlug(slug) {
        ...
        if (!settings || settings.length === 0) {
            throw new common_1.NotFoundException('UI settings not found');
        }
        return settings;
    }
};
exports.UISettingsService = UISettingsService;
exports.UISettingsService = UISettingsService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], UISettingsService);
//# sourceMappingURL=ui-settings.service.js.map